 ...
 * File:        db_devlist.cpp
 *
 * Description: Code for db_devlist test command                                  
 *    		Command rule : To get a list of devices for a server from the static database.          
 *		Synopsis : db_devlist <server name>
 *
 * Author(s):
 *              $Author: jkrueger1 $
 *
