...
#ifndef _xdr_typelist_h
#define _xdr_typelist_h
...
static DevDataListEntry DevData_List [] =
{
   ...
   {D_FLOAT_READPOINT,      xdr_DevFloatReadPoint, sizeof(DevFloatReadPoint),
	                    xdr_length_DevFloatReadPoint},
   {D_STATE_FLOAT_READPOINT,xdr_DevStateFloatReadPoint,
			    sizeof(DevStateFloatReadPoint),
	                    xdr_length_DevStateFloatReadPoint},

   {D_VAR_CHARARR,      xdr_DevVarCharArray,   sizeof(DevVarCharArray),
	                xdr_length_DevVarCharArray},
   {D_VAR_SHORTARR,     xdr_DevVarShortArray,  sizeof(DevVarShortArray),
	                xdr_length_DevVarShortArray},
   {D_VAR_LONGARR,      xdr_DevVarLongArray,   sizeof(DevVarLongArray),
	                xdr_length_DevVarLongArray},
   {D_VAR_FLOATARR,     xdr_DevVarFloatArray,  sizeof(DevVarFloatArray),
	                xdr_length_DevVarFloatArray},

   {D_BPM_POSFIELD,     xdr_DevBpmPosField,    sizeof(DevBpmPosField),
			xdr_length_DevBpmPosField},
   {D_BPM_ELECFIELD,    xdr_DevBpmElecField,   sizeof(DevBpmElecField),
			xdr_length_DevBpmElecField},

   {D_WS_BEAMFITPARM,   xdr_DevWsBeamFitParm,  sizeof(DevWsBeamFitParm),  0},

   {D_VGC_STATUS,       xdr_DevVgcStat,        sizeof(DevVgcStat),
			xdr_length_DevVgcStat},
   {D_VGC_GAUGE,        xdr_DevVgcGauge,       sizeof(DevVgcGauge),
			xdr_length_DevVgcGauge},
   {D_VGC_CONTROLLER,   xdr_DevVgcController,  sizeof(DevVgcController),
   ...
   {D_RAD_DOSE_VALUE,   xdr_DevRadiationDoseValue,
			sizeof(DevRadiationDoseValue),                    0},
   {D_LONG_READPOINT,   xdr_DevLongReadPoint,  sizeof(DevLongReadPoint),  
		        xdr_length_DevLongReadPoint},
   {D_DOUBLE_READPOINT, xdr_DevDoubleReadPoint, sizeof(DevDoubleReadPoint),
		        xdr_length_DevDoubleReadPoint},

   {D_VAR_STRINGARR,    xdr_DevVarStringArray, sizeof(DevVarStringArray),
	                xdr_length_DevVarStringArray},
   {D_VAR_FRPARR,       xdr_DevVarFloatReadPointArray, 
		        sizeof(DevVarFloatReadPointArray),
	                xdr_length_DevVarFloatReadPointArray},
   {D_VAR_THARR,        xdr_DevVarTHArray,     sizeof(DevVarTHArray),
			xdr_length_DevVarTHArray},

   {D_INT_FLOAT_TYPE,   xdr_DevIntFloat,       sizeof(DevIntFloat),
   ...
   {D_STATE_INDIC,      xdr_DevStateIndic,      sizeof(DevStateIndic),
			xdr_length_DevStateIndic},
   {D_BPSS_STATE,       xdr_DevBpssState,       sizeof(DevBpssState),
			xdr_length_DevBpssState},
   {D_BPSS_READPOINT,   xdr_DevBpssReadPoint,   sizeof(DevBpssReadPoint),
			xdr_length_DevBpssReadPoint},

   {D_GPIB_RES,         xdr_DevGpibRes,         sizeof(DevGpibRes),       0},
   {D_GPIB_LOC,         xdr_DevGpibLoc,         sizeof(DevGpibLoc),       0},
   {D_PSS_STATUS,       xdr_DevDaresburyStatus, sizeof(DevDaresburyStatus),
   ...
   {D_CT_LIFETIME,      xdr_DevVarCtIntLifeTimeArray,
   ...
   {D_LIEN_STATE,       xdr_DevLienState,       sizeof(DevLienState),
   ...
   {D_VAR_MSTATARR,     xdr_VarSysStateArray,   sizeof(VarSysStateArray),
   ...
   {D_GRPFP_TYPE,	xdr_DevGrpFramePair,	sizeof(DevGrpFramePair),
			xdr_length_DevGrpFramePair},
   {D_VAR_GRPFPARR,	xdr_DevGrpFramePairArray, sizeof(DevGrpFramePairArray),
			xdr_length_DevGrpFramePairArray},

   {D_PINSTATE_TYPE,	xdr_DevPinState,	sizeof(DevPinState),
			xdr_length_DevPinState},
   {D_VAR_DOUBLEARR,    xdr_DevVarDoubleArray,  sizeof(DevVarDoubleArray),
