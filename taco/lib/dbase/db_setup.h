...
int _DLLFunc db_getdevexp_tango PT_((char *filter,char ***device_tab,u_int *dev_num,DevLong *error)); 	 
int _DLLFunc db_freedevexp_tango PT_((char **buffer));
