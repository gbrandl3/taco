...
//
	...
	{
		logStream->debugStream() << "Pseudo device name : " << rece->psdev_arr.psdev_arr_val[i].psdev_name << log4cpp::eol;
		logStream->debugStream() << "Refresh period : " << rece->psdev_arr.psdev_arr_val[i].poll << log4cpp::eol;
	}
//
