...
#define TACO_COMMAND_DEVICE_INIT 4007
#define TACO_COMMAND_LOGLEVEL 4008
#define TACO_COMMAND_SET_LOGLEVEL 4009
...
namespace TACO {
	...
	namespace Command {
		...
		const DevCommand DEVICE_INIT = TACO_COMMAND_DEVICE_INIT;
		...
		const DevCommand LOGLEVEL = TACO_COMMAND_LOGLEVEL;
		const DevCommand SET_LOGLEVEL = TACO_COMMAND_SET_LOGLEVEL;
	}
}
